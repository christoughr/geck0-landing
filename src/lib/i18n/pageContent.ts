  ...
  ko: {
    ...
    terms: {
      ...
      blocks: [
        ...
        { heading: "결제", body: "좌석당 월/연 구독. 1일 무료 체험 후 유료 전환 시에만 결제(카드 등록 시)." },
        { heading: "문의", body: "hello@geck0.ai" },
      ],
    },
    cookies: {
  ...
  en: {
    ...
    terms: {
      ...
      blocks: [
        ...
        { heading: "Billing", body: "Per-seat monthly/annual billing. 1-day free trial; charges only if you convert with a card on file." },
        { heading: "Contact", body: "hello@geck0.ai" },
      ],
    },
    cookies: {
