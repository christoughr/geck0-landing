  ...
  ko: {
    ...
    api: {
      ...
      blocks: [
        ...
        { body: "Landing OpenAPI spec: /openapi.yaml (waitlist, contact, health). Product REST API v1 at api.geck0.ai — Enterprise early access via hello@geck0.ai." },
      ],
    ...
    terms: {
      ...
      blocks: [
        ...
        { heading: "결제", body: "좌석당 월/연 구독(예정). 베타 기간에는 웨이트리스트만 운영하며 카드·온라인 결제 없음. 유료 전환 시 별도 안내." },
        { heading: "문의", body: "hello@geck0.ai" },
      ],
    },
    cookies: {
  ...
  en: {
    ...
    terms: {
      ...
      blocks: [
        ...
        { heading: "Billing", body: "Per-seat monthly/annual billing (planned). Beta is waitlist-only with no card checkout. We'll notify you before paid conversion." },
        { heading: "Contact", body: "hello@geck0.ai" },
      ],
    },
    cookies: {
