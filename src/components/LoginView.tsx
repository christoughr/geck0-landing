      ...
      <div className="max-w-md mx-auto px-6 py-16">
        ...
        <Reveal delay={0.1}>
          ...
          <div className="bg-purple-900/20 border border-purple-600/20 rounded-xl p-4 text-center">
            <p className="text-purple-200 text-sm mb-3">{t.login.noAccess}</p>
            <Link
              href="/#contact"
              className="text-purple-400 hover:text-purple-300 text-sm font-semibold focus-visible:underline"
            >
              {t.login.waitlist} →
            </Link>
          </div>
